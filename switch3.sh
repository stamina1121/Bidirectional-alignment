...
run_predict() {
    ...
    python -m src.core.predict_vllm2 \
...
data_path="data/unlabelled/falcon-refinedweb-sampled.jsonl"
save_path="${base_output_dir}/predict_iteration${N}/unlabelled.jsonl"
run_predict "$model_path" "$data_path" "$save_path" "content" 0.7 0.9 "--reverse"
...
run_torchrun "$model_name_or_path" "$data_path" "$output_dir" 4 3000
